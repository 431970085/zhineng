    ...
    <div>
        <div class="container">
            ...
            <el-table :data="tableData" size="mini" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                                            <el-table-column prop="dsid" label="记录编号"></el-table-column>
                            <el-table-column prop="uid" label="用户编号"></el-table-column>
                            <el-table-column prop="tid" label="课程编号"></el-table-column>
                            <el-table-column prop="addtime" label="创建时间"></el-table-column>
                            <el-table-column prop="info" label="学习备注"></el-table-column>
        ...
        <el-dialog title="添加" v-model="addVisible" width="45%">
            <el-form size="small" label-width="100px">
                                <el-form-item label="用户编号:">
                                    <el-input placeholder="请输入用户编号" v-model="form.uid">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="课程编号:">
                                    <el-input placeholder="请输入课程编号" v-model="form.tid">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="创建时间:">
                                    <el-input placeholder="请输入创建时间" v-model="form.addtime">
                                    </el-input>
                                </el-form-item>
                                <el-form-item label="学习备注:">
                                    <el-input placeholder="请输入学习备注" v-model="form.info">
                                    </el-input>
                                </el-form-item>
            </el-form>
            <template #footer>
        ...
        <el-dialog title="编辑" v-model="editVisible" width="45%">
            <el-form size="small" label-width="100px">
                        <el-form-item label="记录编号:">
                            <el-input placeholder="请输入记录编号" :disabled="true" v-model="form.dsid">
                            </el-input>
                        </el-form-item>
                                <el-form-item label="用户编号:">
                                    <el-input placeholder="请输入用户编号" v-model="form.uid">
    ...
    export default {
        ...
        setup() {
            ...
            const getData = () => {
                ...
                var sql = " select * from studyinfo  ";
                if (keyword != '') {
                    pageNum = 1;
                    sql = "select * from studyinfo where uid like '%" + keyword + "%'  ";
                }
            ...
            const handleDelete = (index, row) => {
                ...
                ElMessageBox.confirm("确定要删除吗？", "提示", {
                    ...
                    .then(() => {
                        //执行删除操作 接口请求
                        var deleteid = row.dsid;
                        var data = {"sql": "delete  from studyinfo where  dsid='" + deleteid + "' "}
                        request({
                            url: '/updateAction',
                            method: 'get',
                            params: data
            ...
            const saveInsert = () => {
                ...
                var data = {"sql": `insert into studyinfo (dsid,uid,tid,addtime,info)  values ('${obj.dsid}','${obj.uid}','${obj.tid}','${obj.addtime}','${obj.info}')`}
                //执行删除操作 接口请求
                request({
                    url: '/updateAction',
                    method: 'get',
            ...
            const saveEdit = () => {
                ...
                var that = this;
                var obj = form;
                var data = {"sql": `  update studyinfo set uid = '${obj.uid}',tid = '${obj.tid}',addtime = '${obj.addtime}',info = '${obj.info}'  where dsid = '${obj.dsid}'  `}
                request({
                    url: '/updateAction',
                    method: 'get',
                    params: data
